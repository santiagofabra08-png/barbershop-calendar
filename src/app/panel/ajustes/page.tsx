      ...
      <div className="card mt-4 space-y-4 px-5 py-5">
        <div>
          ...
          <p className="mt-1.5 max-w-prose text-sm text-muted">
            ...
            WhatsApp. Cambiarlo los rompería todos de golpe, sin aviso y sin
            forma de arreglarlo. Si hace falta cambiarlo, se coordina.
          </p>
        </div>

        <div className="border-t border-ink/10 pt-4">
          <p className="text-sm font-medium text-ink">El logo</p>
          <p className="mt-1.5 max-w-prose text-sm text-muted">
            Todavía se carga por atrás. Va a estar acá pronto.
          </p>
        </div>
      </div>
    </>
